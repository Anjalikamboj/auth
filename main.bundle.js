...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_fake_backend__ = __webpack_require__("./src/app/helpers/fake-backend.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__angular_core__["NgModule"])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_2__helpers_fake_backend__["a" /* fakeBackendProvider */],
            __WEBPACK_IMPORTED_MODULE_1__angular_http_testing__["a" /* MockBackend */],
            __WEBPACK_IMPORTED_MODULE_7__angular_http__["BaseRequestOptions"]
        ],
    ...
    backend.connections.subscribe(function (connection) {
        ...
        setTimeout(function () {
            ...
            if (connection.request.url.endsWith('/api/authenticate') &&
                ...
                if (body.email === 'm@abc.com' && body.password === '1234') {
...
var AuthService = (function () {
    ...
    AuthService.prototype.isLoggedIn = function () {
        var jHelper = new __WEBPACK_IMPORTED_MODULE_2_angular2_jwt__["JwtHelper"]();
        var token = localStorage.getItem('token');
        if (!token)
            return false;
        var expirationDate = jHelper.getTokenExpirationDate(token);
        var isExpired = jHelper.isTokenExpired(token);
